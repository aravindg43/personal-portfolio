      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div>
              <a
                href={"/assets/Aravind_G_Resume.pdf"}
                download="Aravind_G_Resume.pdf"
              ...
              >
                <button className="px-1 inline-block py-1 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-slate-400 via-fuchsia-300 text-white mb-4">
                  <span className="block bg-zinc-800 hover:bg-zinc-400 rounded-full px-5 py-2">
                    {" "}
                    Download Resume
                  </span>
                </button>
